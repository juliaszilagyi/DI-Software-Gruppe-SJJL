...
### Zusatzfeatures nach Review
Nach dem Review wurden folgende Features ergänzt:

- Kollision Option A (kleinere Rect-Hitbox statt Mask)  
- Pipes erscheinen erst nach ca. 3 Sekunden  
- ESC beendet das Spiel  
- Exit-Button im Start- & Game-Over-Screen  
- Sound AN/AUS Button  
- Pause-Funktion (Taste P)  
- Fenster kann normal geschlossen werden  
